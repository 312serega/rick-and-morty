...
import 'package:flutter_rick_and_morty/screens/app_splash/app_splash.dart';
...
class InitialWidget extends StatelessWidget {
  InitialWidget({Key? key, required this.child}) : super(key: key);
  Widget child;
  @override
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      ...
      child: MultiBlocProvider(
        ...
        child: ChangeNotifierProvider(
          create: (BuildContext context) => MainVm(),
          child: child,
        ),
      ),
    );
