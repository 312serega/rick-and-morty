...
import 'package:flutter_rick_and_morty/screens/user_screen/widgets/my_list_tile_episode.dart';
...
class UserScreen extends StatelessWidget {
  const UserScreen({Key? key, required this.id})
      : super(
          key: key,
        );
  final int id;
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: MyListTile(
                                  title: 'Пол',
                                  subTitle: state.model.gender!,
                                ),
                              ),
                              Expanded(
                                child: MyListTile(
                                  title: 'Раса',
                                  subTitle: state.model.species!,
                                ),
                              ),
                            ],
                          ),
