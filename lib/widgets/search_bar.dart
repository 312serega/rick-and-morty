...
import 'package:flutter_rick_and_morty/screens/users_filter/users_filter.dart';
...
class SearchBar extends StatelessWidget {
  SearchBar({Key? key, required this.userCount}) : super(key: key);
  String? searchValue = '';
  int userCount;
  @override
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: SvgPicture.asset(
                    vm.type ? SvgsSrc.grid : SvgsSrc.list,
                  ),
                  style: ElevatedButton.styleFrom(
                      elevation: 0,
